...
function and(name) {
  (0, _tinyInvariant['default'])(
    typeof name === 'string',
    'perusal.and was called with an invalid name.'
  );
  ...
  (0, _tinyInvariant['default'])(specs.length > 0, 'perusal.and was called without specs.');

  for (var _i = 0, _specs = specs; _i < _specs.length; _i++) {
    var spec = _specs[_i];
    (0, _tinyInvariant['default'])(
      spec instanceof _spec['default'],
      'perusal.and was called with invalid specs.'
    );
  }
